...
void Game::CreateDeviceAndSwapChain()
{
	...
	ZeroMemory(&desc, sizeof(desc));
	{
		...
		desc.BufferDesc.RefreshRate.Numerator = 60;		// 재생 빈도 분자
		desc.BufferDesc.RefreshRate.Denominator = 1;	// 재생 빈도 분모
...
void Game::CreateSRV()
{
	...
	HRESULT hr = ::LoadFromWICFile(L"pngegg.png", WIC_FLAGS_NONE, &md, img);
	CHECK(hr);
...
void Game::CreateConstantBuffer()
{
	...
	desc.ByteWidth = (uint32)(sizeof(TransformData));
